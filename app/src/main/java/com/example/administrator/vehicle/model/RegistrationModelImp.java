...
public class RegistrationModelImp extends BaseModel {
    private Context context = null;
    private ServiceApi serviceApi;
    private CompositeSubscription mCompositeSubscription;

    public RegistrationModelImp(Context context) {
        this.context = context;
        serviceApi = retrofitManager.getService();
        mCompositeSubscription = new CompositeSubscription();
    }
    public void  registration(Map<String, String> map ,final IBaseRequestCallBack<Msg> iBaseRequestCallBack){
        mCompositeSubscription.add(serviceApi.phoneRegistration(map)
